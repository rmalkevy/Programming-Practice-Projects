...
- **Live Embedded Demos.** Embed your [Lab 09](lab-09-signal-processing.md) live spectrogram, [Lab 25](lab-25-platformer-game.md) platformer, [Lab 22](lab-22-spa-frontend.md) dashboard, etc., directly into the project pages as `<iframe>`s. Recruiter clicks, interacts. Magic.
