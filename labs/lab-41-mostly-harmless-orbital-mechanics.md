...
- **It plays beautifully with the rest of your portfolio.** [Lab 13](lab-13-physics-sandbox.md) (physics sandbox) — same integrators. [Lab 03](lab-03-ray-tracer.md) (ray tracer) — same rendering pipeline. [Lab 32](lab-32-neural-net-from-scratch.md) (neural net) — RL controllers for low-thrust trajectories. [Lab 35](lab-35-rtos-mini-autopilot.md) / [37](lab-37-px4-mavlink-drone-stack.md) (RTOS / drone autopilot) — *literally the same control loop*, scaled up. [Lab 02](lab-02-ray-casting-engine.md) / [25](lab-25-platformer-game.md) (rendering / games) — your viz can be a small game.
...
> **Portfolio tip:** the strongest version of this project is one a recruiter can *watch orbit, live*. Aim to ship a browser visualization (Three.js / canvas) of your trajectories and transfers, deployed to GitHub Pages / Vercel, with a GIF of a Hohmann transfer or gravity assist at the top of the README. A mission you can watch play out beats a plot of numbers.
...
- **Real ground-station controller.** Take your pass predictor and (in simulation) drive a 2-axis tracker — compute az/el commands, plot the antenna's required motion. *[Lab 35](lab-35-rtos-mini-autopilot.md) / [37](lab-37-px4-mavlink-drone-stack.md) link if you want it on real motors.*
...
- **Combine with [Lab 03](lab-03-ray-tracer.md).** Render your trajectories with your own ray tracer — proper specular planets and lit space.
...
- **Combine with [Lab 35](lab-35-rtos-mini-autopilot.md) / [37](lab-37-px4-mavlink-drone-stack.md).** Run your guidance algorithm on PX4 SITL. The drone "thinks" it's a probe.
