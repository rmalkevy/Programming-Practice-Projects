...
- Connects beautifully to other labs: the graph algorithms from **[Lab 07](lab-07-graph-route-finder.md)/[10](lab-10-maze-generator-solver.md)**, the platformer from **[Lab 25](lab-25-platformer-game.md)**, the multiplayer from **[Lab 27](lab-27-multiplayer-browser-game.md)**, the AI from **[Lab 32](lab-32-neural-net-from-scratch.md)–[34](lab-34-ai-capstone.md)**. A roguelike is a melting pot.
...
> **Portfolio tip:** the strongest version of this project is one a recruiter can *play in the browser*. Ship a web build (or an itch.io HTML5 export), link it at the top of the README, and add a GIF plus a shareable seed. Letting someone generate their own dungeon in one click is the whole pitch.
...
- **A\* Pathfinding for Enemies.** Enemies don't just walk randomly; they path-find to the player. Connects to [Lab 07](lab-07-graph-route-finder.md).
...
- **Combine With [Lab 07](lab-07-graph-route-finder.md) (Pathfinding).** Use proper A\* for enemies, prove that the algorithm gives different (and better) AI than random walks. Document the difference in your README with GIFs.
